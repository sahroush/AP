...
int Errand::get_start() { return mission->get_start(); }

int Errand::get_end() { return end_time; }

int Errand::get_reward() { return mission->get_reward(); }

string Errand::get_status() { return (is_done ? "completed" : "ongoing"); }
