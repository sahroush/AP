...
void System::add_time_mission(int mission_id, int st_time, int ed_time,
  ...
  if (missions.count(mission_id)) {
    ...
    try {
      missions[mission_id] =
          new TimeMission(mission_id, st_time, ed_time, target_time, reward);
      cout << OK << endl;
    } catch (exception &e) {
      cout << e.what() << endl;
    }
...
void System::add_dist_mission(int mission_id, int st_time, int ed_time,
  ...
  if (missions.count(mission_id)) {
    ...
    try {
      missions[mission_id] =
          new DistMission(mission_id, st_time, ed_time, target_dist, reward);
      cout << OK << endl;
    } catch (exception &e) {
      cout << e.what() << endl;
    }
...
void System::add_count_mission(int mission_id, int st_time, int ed_time,
  ...
  if (missions.count(mission_id)) {
    ...
    try {
      missions[mission_id] =
          new CountMission(mission_id, st_time, ed_time, target_cnt, reward);
      cout << OK << endl;
    } catch (exception &e) {
      cout << e.what() << endl;
    }
...
void System::record_ride(int st_time, int ed_time, int driver_id,
                         int distance) {
  try {
    if (drivers.count(driver_id))
