...
static map<string, Commands> COMMAND = {
    {"add_time_mission", TIME_MSN}, {"add_distance_mission", DIST_MSN},
    {"add_count_mission", CNT_MSN}, {"assign_mission", ASSIGN},
    {"record_ride", RIDE},          {"show_missions_status", SHOW}};
...
struct TimeRange {
  ...
  int len() { return r - l; }
  bool contains(TimeRange &other) { return l <= other.l and other.r <= r; }
};
